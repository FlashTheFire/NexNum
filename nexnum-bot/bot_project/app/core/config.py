...
class Settings(BaseSettings):
    ...
    INBOUND_WORKER_COUNT: int = 5                # Number of Redis Stream consumer workers (5 workers)
    ENABLE_IN_PROCESS_WORKERS: bool = True       # True = Unified in-process mode inside nexnum-bot
