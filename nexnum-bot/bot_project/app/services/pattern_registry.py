    ...
    def save_pattern_to_disk(cls, service_code: str, pattern_data: dict) -> bool:
        ...
        try:
            ...
            defaults[code] = {
                ...
                "stock_multiplier": float(pattern_data.get("stock_multiplier", 2.0) or 2.0),
                "base_stock_boost": int(pattern_data.get("base_stock_boost", 0) or 0),
                "max_stock_cap": int(pattern_data.get("max_stock_cap", 50000) or 50000),
