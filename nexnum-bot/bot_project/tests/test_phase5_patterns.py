...
class TestPhase5PatternRegistry(unittest.TestCase):
    ...
    def test_02_dynamic_sms_matching(self):
        ...
        # Telegram
        m1, code1 = loop.run_until_complete(ServicePatternRegistry.match_sms_dynamic(None, "Telegram login code: 54321", "Telegram", "tg"))
        self.assertTrue(m1)
        self.assertEqual(code1, "54321")

        # WhatsApp
        m2, code2 = loop.run_until_complete(ServicePatternRegistry.match_sms_dynamic(None, "Your WhatsApp code: 123-456", "WhatsApp", "wa"))
        self.assertTrue(m2)
        self.assertEqual(code2, "123456")

        # Google
        m3, code3 = loop.run_until_complete(ServicePatternRegistry.match_sms_dynamic(None, "G-987654 is your Google verification code", "Google", "go"))
        self.assertTrue(m3)
        self.assertEqual(code3, "987654")

        # Amazon
        m4, code4 = loop.run_until_complete(ServicePatternRegistry.match_sms_dynamic(None, "Use code 456789 for Amazon login", "AD-AMAZON-T", "am"))
        self.assertTrue(m4)
