...
export default function NotFound() {
    ...
    return (
        <div className="min-h-screen w-full bg-[#030305] flex flex-col items-center justify-center relative overflow-hidden selection:bg-[hsl(var(--neon-lime))] selection:text-black">
            ...
            <div className="relative flex flex-col items-center max-w-lg px-6 text-center z-10 w-full">
                ...
                >
                    ...
                    <div className="flex flex-col sm:flex-row items-center gap-6 w-full justify-center">
                        ...
                        <Link href={`/${locale}`} className="text-[10px] font-mono text-white/30 hover:text-[hsl(var(--neon-lime))] tracking-[0.3em] uppercase transition-colors duration-300 py-2">
                            Back to Home
                        </Link>
                    </div>
                </motion.div>
