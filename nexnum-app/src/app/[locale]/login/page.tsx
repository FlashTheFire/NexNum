                                ...
                                <AuthCard>
                                    ...
                                    <form onSubmit={handleSubmit} className="space-y-4">
                                        ...
                                        <Button type="submit" disabled={isLoading} className="w-full h-12 bg-[hsl(var(--neon-lime))] text-black font-bold hover:bg-[hsl(var(--neon-lime-soft))] disabled:opacity-50 neon-glow transition-all shadow-lg shadow-[hsl(var(--neon-lime)/0.25)]">
                                            {isLoading ? <div className="flex items-center gap-2"><div className="w-4 h-4 border-2 border-black/30 border-t-black rounded-full animate-spin" />Signing in...</div> : <>Sign In<ArrowRight className="ml-2 w-4 h-4" /></>}
                                        </Button>
                                    </form>
                                ...
                                >
                                    ...
                                    <motion.div className="grid grid-cols-2 gap-4" initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.5 }}>
                                        <Button
                                            ...
                                            className="h-12 border-white/10 bg-white/[0.02] text-white hover:bg-white/[0.05] hover:border-white/20 transition-all"
                                        >
                                        ...
                                        <Button variant="outline" className="h-12 border-white/10 bg-white/[0.02] text-white hover:bg-white/[0.05] hover:border-white/20 transition-all">
