...
import {
    ...
    Lock, Smartphone, ArrowRight, Info, Edit, Plug, Link
} from "lucide-react"
...
export default function ProviderWizard({ onComplete, onCancel }: WizardProps) {
    ...
    const [configTab, setConfigTab] = useState<'endpoints' | 'mappings'>('endpoints')
            ...
            <div className="flex-1 overflow-y-auto pr-2 custom-scrollbar">
                <AnimatePresence mode="wait">
                    ...
                    {step === 5 && (
                        ...
                        >
                            {/* Pro Tip/Alert for Future Proofing */}
                            <div className="bg-blue-500/10 border border-blue-500/20 rounded-xl p-4 flex gap-4 items-start">
                                ...
                                <div className="space-y-1">
                                    <h4 className="text-sm font-bold text-blue-200">Universal Integration Engine</h4>
                                    <p className="text-xs text-blue-200/60 leading-relaxed">
                                        Some providers (like 5sim or GrizzlySMS) use a <strong>Hybrid Approach</strong>:
                                        Rest API (Bearer Token) for listing services, but Legacy query-params for buying numbers.
                                        Use the <strong>Variable Helper</strong> to inject specific auth keys into URLs where needed.
                                    </p>
                                </div>
                            </div>
                            ...
                            <div className="flex-1 grid grid-cols-1 md:grid-cols-3 gap-6">
                                {/* Main Editor Area */}
                                <div className="md:col-span-2 bg-[#0a0a0c]/60 backdrop-blur-xl border border-white/5 rounded-2xl overflow-hidden flex flex-col">
                                    {/* Tabs Header */}
