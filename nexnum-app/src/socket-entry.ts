...
// NOTE: Do NOT set NODE_TLS_REJECT_UNAUTHORIZED=0 globally.
// Set rejectUnauthorized: false per-client (ioredis) if connecting to internal
// services with self-signed certs. Global bypass disables verification for ALL
// outbound TLS including Supabase, Meilisearch, and third-party APIs.
