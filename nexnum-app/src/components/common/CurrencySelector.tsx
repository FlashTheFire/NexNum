        ...
        <DropdownMenu>
            <DropdownMenuTrigger asChild>
                ...
                >
                    ...
                    <span className="text-xs font-mono font-bold">{preferredCurrency}</span>
            ...
            >
                {Object.values(currencies).map((cur) => (
                    <DropdownMenuItem
                        ...
                        className={`flex items-center justify-between px-3 py-2 rounded-xl cursor-pointer transition-all ${preferredCurrency === cur.code
