    ...
    return (
        <section className="py-24 bg-primary text-primary-foreground relative overflow-hidden">
            ...
            <div className="container mx-auto px-4 relative z-10 text-center">
                ...
                {/* Social Links */}
                <div className="mt-12 pt-8 border-t border-primary-foreground/20 flex items-center justify-center gap-8">
                    <a href="https://x.com/TheNexNum" target="_blank" rel="noopener noreferrer" className="opacity-70 hover:opacity-100 transition-opacity">
                    ...
                    <a href="https://github.com/nexnum" target="_blank" rel="noopener noreferrer" className="opacity-70 hover:opacity-100 transition-opacity">
                    ...
                    <a href="https://discord.gg/fZs296Kgue" target="_blank" rel="noopener noreferrer" className="opacity-70 hover:opacity-100 transition-opacity">
                    ...
                    <a href="https://www.instagram.com/thenexnum" target="_blank" rel="noopener noreferrer" className="opacity-70 hover:opacity-100 transition-opacity">
                    ...
                    <a href="https://www.youtube.com/@TheNexNum" target="_blank" rel="noopener noreferrer" className="opacity-70 hover:opacity-100 transition-opacity">
